...
const GRAVITY = 0.0004; // Very gentle gravity for smooth falling
const FLAP_POWER = -0.006; // Very gentle upward force for precise control
const MAX_VELOCITY = 0.01; // Stricter speed limit for smoother movement
const WAVE_WIDTH = 80;
