...
const GRAVITY = 0.0001; // Extremely gentle gravity for smooth falling
const FLAP_POWER = -0.002; // Extremely gentle upward force for precise control
const MAX_VELOCITY = 0.005; // Very strict speed limit for smoother movement
const WAVE_WIDTH = 80;
