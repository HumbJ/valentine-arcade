...
const LEVELS: Level[] = [
  {
    ...
    cars: [
      ...
      { id: 4, row: 3, col: 3, length: 3, orientation: "vertical", isTaxi: false, color: "#F38181" },
    ],
  },
  {
    id: 2,
    ...
    cars: [
      ...
      { id: 1, row: 0, col: 0, length: 2, orientation: "vertical", isTaxi: false, color: "#FF6B6B" },
      { id: 2, row: 0, col: 2, length: 3, orientation: "vertical", isTaxi: false, color: "#4ECDC4" },
      { id: 3, row: 0, col: 3, length: 2, orientation: "horizontal", isTaxi: false, color: "#95E1D3" },
      { id: 4, row: 3, col: 0, length: 2, orientation: "horizontal", isTaxi: false, color: "#F38181" },
  ...
  },
  {
    ...
    cars: [
      { id: 0, row: 2, col: 0, length: 2, orientation: "horizontal", isTaxi: true, color: "#FFD700" },
      { id: 1, row: 0, col: 2, length: 3, orientation: "vertical", isTaxi: false, color: "#FF6B6B" },
